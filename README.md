...
## Autorzy
* **Karol Kacprzak** - [Profil GitHub](https://github.com/Karol315)
* **Mateusz Jamroż** - [Profil GitHub](https://https://github.com/matjamroz)
...
### Diagram Komponentów (Logiczny przepływ danych)
![Component Diagram](../Images/ComponentDiagram.drawio.png)

### Diagram Wdrożenia (Infrastruktura fizyczna)
...
![stress test results](../Images/stress_test_results.png)
